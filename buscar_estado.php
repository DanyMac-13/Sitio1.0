...
<body>
    ...
    <?php
    //Se crea la variable para almacenar la busqueda
    ...
    <nav class="navbar ">
        <form class="form-inline" action="buscar_estado.php" method="get">
            <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" name="busqueda" id="busqueda" value="<?php echo $busqueda; ?>">
    ...
    <table border="2" align="center" id="tablaEstados">
        <tr align="center">
            <td width="300">Num.</td>
        ...
        <?php
//consulta en la tabla estados y revisa si lo almacenado en busqueda se encuentra en la tabla, y la informacion encontrada es mostrada
        $sql = "SELECT * FROM estados WHERE ( idEstado LIKE '%$busqueda%' OR nombreEs LIKE '%$busqueda%' );";
