...
<!--  Codigo html para mostrar la pagina de registro-->
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <link rel="icon" type="image/png" href="img/form.png">
</head>
                ...
                <div class="wrapper">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <center>
                            ...
                            <p>¿Ya tienes una cuenta? <a href="login.php">
                                    <FONT COLOR="navy">Ingresa aquí</FONT>
                                </a>.</p>
                        </center>
                    </form>
                </div>
